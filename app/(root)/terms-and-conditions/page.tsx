...
const Page = () => {
  return (
    <div className="md:p-10 p-3 flex flex-col gap-2">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to SRT Transport Inc., 2 carroll lane
            Brantford ont N3T0G1.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to SRT Transport Inc., accessible
            from{" "}
            <a
              href="https://www.srttransportinc.com"
      ...
      <ul>
        <li>By email: info@srttransportinc.com</li>
      </ul>
    </div>
  );
};
